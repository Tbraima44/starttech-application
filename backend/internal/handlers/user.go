...
import (
	...
	"github.com/Tbraima44/starttech-application/backend/internal/models"
)
...
func (h *UserHandler) Register(c *gin.Context) {
    ...
    slog.Warn("Failed to cache username", "error", err)
}
...
func (h *UserHandler) triggerRandomCacheRefresh() {
    ...
    slog.Warn("Failed to set username cache initialized", "error", err)
}
